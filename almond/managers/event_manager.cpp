...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_closed(const std::optional<sf::Event> event) { // FUNC@_internal_on_closed
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_resized(const std::optional<sf::Event> event) { // FUNC@_internal_on_resized
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_focus_lost(const std::optional<sf::Event> event) { // FUNC@_internal_on_focus_lost
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_focus_gained(const std::optional<sf::Event> event) { // FUNC@_internal_on_focus_gained
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_entered(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_entered
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_left(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_left
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_text_entered(const std::optional<sf::Event> event) { // FUNC@_internal_on_text_entered
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_key_pressed(const std::optional<sf::Event> event) { // FUNC@_internal_on_key_pressed
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_key_released(const std::optional<sf::Event> event) { // FUNC@_internal_on_key_released
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_wheel_scrolled(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_wheel_scrolled
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_button_pressed(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_button_pressed
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_button_released(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_button_released
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_mouse_moved(const std::optional<sf::Event> event) { // FUNC@_internal_on_mouse_moved
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_joystick_button_pressed(const std::optional<sf::Event> event) { // FUNC@_internal_on_joystick_button_pressed
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_joystick_button_released(const std::optional<sf::Event> event) { // FUNC@_internal_on_joystick_button_released
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_joystick_moved(const std::optional<sf::Event> event) { // FUNC@_internal_on_joystick_moved
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_joystick_connected(const std::optional<sf::Event> event) { // FUNC@_internal_on_joystick_connected
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_joystick_disconnected(const std::optional<sf::Event> event) { // FUNC@_internal_on_joystick_disconnected
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_touch_began(const std::optional<sf::Event> event) { // FUNC@_internal_on_touch_began
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_touch_moved(const std::optional<sf::Event> event) { // FUNC@_internal_on_touch_moved
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_touch_ended(const std::optional<sf::Event> event) { // FUNC@_internal_on_touch_ended
...
// -----------------------------------------------------------------------------
bool nd::EventManager::_internal_on_sensor_changed(const std::optional<sf::Event> event) { // FUNC@_internal_on_sensor_changed
