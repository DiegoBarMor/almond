#include "parser_strings.hpp"

// -----------------------------------------------------------------------------
bool nd::ParserStrings::str2bool(std::string raw_str) { // FUNC@str2bool
    return raw_str == "T" || raw_str == "TRUE" || raw_str == "1";
} // END@str2bool


// -----------------------------------------------------------------------------
float nd::ParserStrings::str2float(std::string raw_str) { // FUNC@str2float
    try {
...
// -----------------------------------------------------------------------------
float nd::ParserStrings::str2ratio(std::string raw_str) { // FUNC@str2ratio
    return std::min(1.0f, std::max(0.0f, nd::ParserStrings::str2float(raw_str)));
} // END@str2ratio


// -----------------------------------------------------------------------------
sf::Color nd::ParserStrings::str2color(std::string raw_str) { // FUNC@str2color
    size_t pos;
